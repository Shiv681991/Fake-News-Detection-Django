...
os.chdir(r'C:\Users\AD20168019\Desktop\Tweepy_Scripts\statewise_tweets')
dir_list = glob.glob("*.csv")
file_list = glob.glob(r"C:\Users\AD20168019\Desktop\Tweepy_Scripts\statewise_tweets\*.csv")
#print(dir_list)
