...
def evaluate_file(dev_file, submission_file):
...
if __name__ == '__main__':
    ...
    question="What makes energy changes in a Donald Trump's system?"

    dev_data=convert_qa_2_squad(context,question)
    dev_data = [item for topic in dev_data['data'] for item in topic['paragraphs']]

    preds = model_albert_large_v1.predict(dev_data)
    print(preds)
    print(preds[0]['answer'])
